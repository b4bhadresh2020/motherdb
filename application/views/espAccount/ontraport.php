                                                ...
                                                if(isset($listArr) && count($listArr)){                     
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="toggle-button-cover custom-toggle">
                                                                <div class="button-cover">
                                                                    <div class="button b2" id="switch-btn">
                                                                        <input type="checkbox" class="checkbox" <?=($account['status'] == 1 ? 'checked':'')?> value="<?=$account['id']?>" data-esp="12"/>
                                                                        <div class="knobs"></div>
                                                                        <div class="layer"></div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <?php
                                                            $totalLog = getAccountStatusLog(12, $account['id']);
                                                            if($totalLog > 0) {
                                                            ?>
                                                                <a href="<?php echo site_url('/espAccount/statusLogData/0?esp=12&accountId='.$account['id'])?>" class="btn btn-default db-log-btn" title = "status log">Log</a> 
                                                            <?php } ?>
                                                        </td>
                                                    </tr>
                                            <?php }} ?>

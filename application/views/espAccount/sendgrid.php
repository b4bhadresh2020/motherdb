                                                ...
                                                if(isset($listArr) && count($listArr)){                     
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <?php
                                                            $totalLog = getAccountStatusLog(5, $account['id']);
                                                            if($totalLog > 0) {
                                                            ?>
                                                                <a href="<?php echo site_url('/espAccount/statusLogData/0?esp=5&accountId='.$account['id'])?>" class="btn btn-default db-log-btn" title = "status log">Log</a> 
                                                            <?php } ?>
                                                        </td>
                                                    </tr>
                                            <?php }} ?>

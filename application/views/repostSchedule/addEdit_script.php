<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$('#btn_insert').click(function() {
			...
			if (select_apikey == '') {
				...
				//get data
				$.ajax({
					url: BASEPATH + 'repostSchdule/getApiKeyData',
					type: 'post',
					dataType: 'json',
					data: {
	...
	function getProvider(provider, apiData, groupName, keyword) {
		var providerId = 0;
		$.ajax({
			url: BASEPATH + 'repostSchedule/getProvider',
			type: 'post',
			data: {
				id: provider
			},
	...
	function sendEmailToEgoi(apiData) {
		...
		$.ajax({
			url: BASEPATH + 'repostSchedule/addDataToEgoi',
			type: 'post',
			data: {
	...
	function sendEmailToAweber(apiData, provider, groupName, keyword) {
		...
		$.ajax({
			url: BASEPATH + 'repostSchedule/addDataToAweber',
			type: 'post',
			data: {
				apiDataDetail: apiDataDetail,
				provider: provider,
	...
	function sendEmailToConstantContact(apiData, provider, groupName, keyword) {
		...
		$.ajax({
			url: BASEPATH + 'repostSchedule/addDataToConstantContact',
			type: 'post',
			data: {
				apiDataDetail: apiDataDetail,
				provider: provider,
	...
	function sendEmailToTransmitvia(apiData, provider, groupName, keyword) {
		...
		$.ajax({
			url: BASEPATH + 'repostSchedule/addDataToTransmitvia',
			type: 'post',
			data: {
				apiDataDetail: apiDataDetail,
				provider: provider,
	...
	function sendEmailToOngage(apiData, provider, groupName, keyword) {
		...
		$.ajax({
			url: BASEPATH + 'repostSchedule/addDataToOngage',
			type: 'post',
			data: {
				apiDataDetail: apiDataDetail,
				provider: provider,
	...
	function sendEmailToSendgrid(apiData, provider, groupName, keyword) {
		...
		$.ajax({
			url: BASEPATH + 'repostSchedule/addDataToSendgrid',
			type: 'post',
			data: {
				apiDataDetail: apiDataDetail,
				provider: provider,
	...
	function sendEmailToSendInBlue(apiData, provider, groupName, keyword) {
		...
		$.ajax({
			url: BASEPATH + 'repostSchedule/addDataToSendInBlue',
			type: 'post',
			data: {
				apiDataDetail: apiDataDetail,
				provider: provider,
	...
	function sendEmailToSendpulse(apiData, provider, groupName, keyword) {
		...
		$.ajax({
			url: BASEPATH + 'repostSchedule/addDataToSendpulse',
			type: 'post',
			data: {
				apiDataDetail: apiDataDetail,
				provider: provider,
	...
	function sendEmailToMailerlite(apiData, provider, groupName, keyword) {
		...
		$.ajax({
			url: BASEPATH + 'repostSchedule/addDataToMailerlite',
			type: 'post',
			data: {
				apiDataDetail: apiDataDetail,
				provider: provider,
	...
	function sendEmailToMailjet(apiData, provider, groupName, keyword) {
		...
		$.ajax({
			url: BASEPATH + 'repostSchedule/addDataToMailjet',
			type: 'post',
			data: {
				apiDataDetail: apiDataDetail,
				provider: provider,
	...
	function sendEmailToConvertkit(apiData, provider, groupName, keyword) {
		...
		$.ajax({
			url: BASEPATH + 'repostSchedule/addDataToConvertkit',
			type: 'post',
			data: {
				apiDataDetail: apiDataDetail,
				provider: provider,
	...
	function sendEmailToMarketingPlatform(apiData, provider, groupName, keyword) {
		...
		$.ajax({
			url: BASEPATH + 'repostSchedule/addDataToMarketingPlatform',
			type: 'post',
			data: {
				apiDataDetail: apiDataDetail,
				provider: provider,
	...
	function sendEmailToOntraport(apiData, provider, groupName, keyword) {
        ...
        $.ajax({
            url: BASEPATH + 'repostSchedule/addDataToOntraport',
            type: 'post',
            data: {
                apiDataDetail: apiDataDetail,
                provider: provider,
	...
	function sendEmailToActiveCampaign(apiData, provider, groupName, keyword) {
		...
		$.ajax({
			url: BASEPATH + 'repostSchedule/addDataToActiveCampaign',
			type: 'post',
			data: {
				apiDataDetail: apiDataDetail,
				provider: provider,

                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="country" class="form-control">
                                                        ...
                                                        <?php foreach ($countries as $ctry) { ?>
                                                            <option value="<?php echo $ctry['country']; ?>" <?php if (@$country == $ctry['country']) {
                                                                                                                echo 'selected';
                                                                                                            } ?>><?php echo $ctry['country']; ?></option>
                                                        <?php } ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="mailProvider[]" class="form-control " id="mailProvider" multiple="multiple">
                                                        <?php foreach ($mailProviders as $key => $value) { ?>
                                                            <option value="<?php echo $key; ?>" <?php if (in_array($key, @$mailProvider)) {
                                                                                                    echo 'selected';
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select id="identifier" name="identifier" class="form-control">
                                                        ...
                                                        <?php foreach ($identifiers as $key => $value) { ?>
                                                            <option value="<?php echo $key; ?>" <?php if (@$identifier == $key) {
                                                                                                    echo 'selected';
                                                                                                } ?>><?php echo $value; ?></option>
                                                        <?php } ?>
                                                    </select>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select id="dataSourceType" name="dataSourceType" class="form-control" <?= (!empty($liveDeliveryId) ? "disabled" : "") ?>>
                                                        ...
                                                        foreach ($dataSourceTypes as $key => $value) { ?>
                                                            <option value="<?php echo $key; ?>" <?php if (@$dataSourceType == $key) {
                                                                                                    echo 'selected';
                                                                                                } ?>><?php echo $value; ?></option>
                                                        <?php }
                                                        ?>
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select id="integromatHookId" name="integromatHookId" class="form-control">
                                                        ...
                                                        <?php foreach ($integromatHooks as $hook) { ?>
                                                            <option value="<?php echo $hook['id']; ?>" <?php if ($hook['id'] == @$integromatHookId) {
                                                                                                            echo 'selected';
                                                                                                        } ?>><?php echo $hook['hook_name']; ?></option>
                                                        <?php } ?>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-3">
                                                <div class="form-group">
                                                    ...
                                                    <div class="checkbox">
                                                        <label>
                                                            <input id="isCheckIp" type="checkbox" name="isCheckIp" value="1" <?php echo (@$isCheckIp) ? "checked" : "" ?> />
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-3">
                                                <div class="form-group">
                                                    <label>IP check time in minutes</label>
                                                    <input type="number" class="form-control" name="ipInterval" value="<?php echo @$ipInterval; ?>" min=1 max=60>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">

        ...
        <div class="container-fluid">
            ...
            <section id="main-content">
                ...
                <div class="row main page-header">
                    <div class="col-lg-12 title-margin-right card">
                        <ul class="tabs">
                            <li class="tab-link current" data-tab="tab-1">Keyword %</li>
                            <li class="tab-link" data-tab="tab-2">Enrichment Result %</li>
                            <li class="tab-link" data-tab="tab-3">Country Wise % By Keyword</li>
                            <li class="tab-link" data-tab="tab-4">Male / Female %</li>
                        </ul>
                        ...
                        <div id="tab-1" class="tab-content current">
                           ...
                           <div class="row">
                                ...
                                <!-- <div class="col-lg-6 col-md-12 col-sm-12">
                                    <div class="card Batch_stat">
                                        <div class="card-header">
                                            <div class="row">
                                                <div class="col-lg-10">
                                                    <h4>Batch / Segment Stat </h4>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="card-body">
                                                ...
                                                <table class="table table-bordered">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th>Total</th>
                                                            <th>Active / Clickers</th>
                                                            <th>Active / Clickeres Percentage</th>
                                                            <th>Unsubscribed</th>
                                ...
                                <div class="col-lg-6">
                                    <div class="card">
                                        <div class="card-header">
                                            <div class="row">
                                                <div class="col-lg-10">
                                                    <h4>Enrichment Result Percentage</h4>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="card-body">
                                            <div class="table-responsive">
                                                <table class="table table-bordered">
                                                    ...
                                                    <tbody>
                                                        <?php
                                                            $i = 0 + $start;
                                                            foreach ($result['listArr'] as $curEntry) {
                                                                    $i++;
                                                                    ...
                                                                    $totalGroupCount_sql = "SELECT sum(male + female) as total from ".GROUP_MASTER." WHERE groupName = '$groupName_con'";
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6 " style="padding-top: 25px;">
                                                    <div class="datatable_pageinfo"><?php echo @$result['pageinfo']; ?></div>
                                                </div>
                                                <div class="col-lg-6 ">
                                                    <div class="paginate_links pull-right"><?php echo @$result['links']; ?></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>

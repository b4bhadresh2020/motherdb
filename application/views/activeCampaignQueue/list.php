                        ...
                        <div class="card alert">
                            ...
                            <div class="card-body">
                                <div class="horizontal-form-elements">
                                    <form class="form-horizontal" method="get" action="<?php echo base_url('ActiveCampaignQueue/manage/0'); ?>">
                                        <div class="row">
                                            <div class="col-lg-8">                                                
                                                <div class="row">
                                                    <div class="col-lg-3">
                                                    ...
                                                    <div class="col-lg-3">
                                                        <div class="form-group">
                                                            <label>Active Campaign Listname</label>
                                                            <select name="providerId" class="form-control">
                                                                <option value="">Select Active Campaign List</option>
                                                                <?php foreach ($activeCampaignList as $list) { ?>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <h4>Active Campaign Queue User List </h4>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table class="table table-bordered">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Status</th>
                                                <th>Active Campaign Response</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php

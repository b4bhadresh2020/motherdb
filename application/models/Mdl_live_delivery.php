    ...
    public function getLiveDeliveryStatData($getData,$start,$perPage,$wantToDataRecords = FALSE) {
        ...
        if ($chooseFilter == 'td') {
            ...
            if($wantToDataRecords){
                ...
                $reasonArr = array(1 => 'duplicateCount', 2 => 'blacklistCount', 3 => 'serverIssue', 4 => 'apiKeyIsNotActive', 5 => 'emailIsRequired', 6 => 'phoneIsRequired', 7 => 'emailIsBlank', 8 => 'phoneIsBlank', 9 => 'invalidEmailFormat', 10 => 'invalidPhone', 11 => 'invalidGender' );

...
class Mdl_live_delivery extends CI_Model
{
    ...
    function getRejectDetailCount($startDate, $endDate, $apikey)
    {
        ...
        $reasonArr = array(
            ...
            19 => 'duplicateOld',
            20 => 'blacklistIP',
            21 => 'protonmailMxBlock',
            22 => 'rejectByInboxgame',
            23 => 'rejectByIntegromat',
            24 => 'ageIsRequired',
            25 => 'hotmailMxBlock',
            26 => 'outlookMxBlock',
            27 => 'liveMxBlock',
    ...
    function getStatCounter($apikey, $startDate = null, $endDate = null)
    {
        ...
        $getCounterSql = "SELECT
            ...
            , SUM(CASE sucFailMsgIndex
                WHEN '25' THEN 1
                ELSE 0
                END) AS hotmailMxBlock    
            , SUM(CASE sucFailMsgIndex
                WHEN '26' THEN 1
                ELSE 0
                END) AS outlookMxBlock    
            , SUM(CASE sucFailMsgIndex
                WHEN '27' THEN 1
                ELSE 0
                END) AS liveMxBlock    

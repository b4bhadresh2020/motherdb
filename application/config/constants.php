...
define("OMNISEND_DELAY_USER_DATA",	"omnisend_delay_user_data");
...
define("LIVE_DELIVERY_LEADBYTE_DATA", "live_delivery_leadbyte_data");
...
define('HOTMAIL_DOMAIN', 'hotmail');
define('OUTLOOK_DOMAIN', 'outlook');
define('LIVE_DOMAIN', 'live');
define('MSN_DOMAIN', 'msn');

...
class Cron_upload_csv extends CI_Controller
{
    ...
    public function upload_csv_data() {
        ...
        $condition = array();
        $is_single = FALSE;
        $getCsvData = GetAllRecord(CSV_FILE_DATA,$condition,$is_single,array(),array(),array(array('csvFileDataId' => 'ASC')));
    ...
    function insertInDB($csvDataArr,$csvFileData){
        ...
        $condition = array();
        $is_insert = true;
        $lastInsertedId = ManageData(TEST,$condition,$dataArr,$is_insert);
